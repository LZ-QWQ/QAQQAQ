...
hparams = tf.contrib.training.HParams(
	...
	#Limits
	min_level_db = -120,#-100
	ref_level_db = 20,
	#fmin = 55, #Set this to 55 if your speaker is male! if female, 95 should help taking off noise. (To test depending on dataset. Pitch info: male~[65, 260], female~[100, 525])
	fmin=125,#如你所说试一试~我就按照这个试一下了
	...
	tacotron_batch_size = 42, #number of training samples on each training steps
	...
	tacotron_start_decay = 30000, #Step at which learning decay starts 40000
	tacotron_decay_steps = 10000, #Determines the learning rate decay slope (UNDER TEST)18000
	tacotron_decay_rate = 0.5, #learning rate decay rate (UNDER TEST)
	tacotron_initial_learning_rate = 1e-3, #starting learning rate
	tacotron_final_learning_rate = 1e-5, #minimal learning rate 1e-4
	...
	#train/test split ratios, mini-batches sizes
	wavenet_batch_size = 12, #batch size used to train wavenet.
	...
	wavenet_decay_rate = 1, #Only used with 'exponential' scheme. Defines the decay rate. 0.5
    ...
    #    " lv4 shi4 yang2 chun1 yan1 jing3 da4 kuai4 wen2 zhang1 de5 di3 se4",
    #    " si4 yue4 de5 lin2 luan2 geng4 shi4 lv4 de2 xian1 huo2 xiu4 mei4 shi1 yi4 ang4 ran2",
    #    "bai2 jia1 xuan1 hou4 lai2 yin2 yi3 hao2 zhuang4 de shi4 yi4 sheng1 li3 qu3 guo4 qi1 fang2 nv3 ren2 .",
	   # "qu3 tou2 fang2 xi2 fu4 shi2 ta1 gang1 gang1 guo4 shi2 liu4 sui4 sheng1 ri4 .",
	   # "na4 shi4 xi1 yuan2 shang4 gong3 jia1 cun1 da4 hu4 gong3 zeng1 rong2 de tou2 sheng1 nv3 ,",
	   # "bi3 ta1 da4 liang3 sui4 .",
 ...
 #   [
	...
	#Wavenet Debug 这好像有点问题emmm
	wavenet_synth_debug = False, #Set True to use target as debug in WaveNet synthesis. 
	wavenet_debug_wavs = ['training_data/audio/audio-000001.npy'], #Path to debug audios. Must be multiple of wavenet_num_gpus.
	wavenet_debug_mels = ['training_data/mels/mel-000001.npy'], #Path to corresponding mels. Must be of same length and order as wavenet_debug_wavs.
