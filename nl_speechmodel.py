...
class SpeechModel():
    ...
    def CreateModel(self):
        ...
        #这个 1 是为了后面的conv2d
        layer_1=Conv2D(16,(3,3),use_bias=True,activation='relu',padding='same',
                       kernel_initializer='he_normal')(input_data)
        layer_1=Dropout(0.05)(layer_1)
        layer_2=Conv2D(16,(3,3),use_bias=True,activation='relu',padding='same',
        ...
        layer_4=Conv2D(16,(3,3),use_bias=True,activation='relu',padding='same',
                       kernel_initializer='he_normal')(layer_3)
        layer_4=Dropout(0.1)(layer_4)
        layer_5=Conv2D(16,(3,3),use_bias=True,activation='relu',padding='same',
        ...
        layer_7=Conv2D(32,(3,3),use_bias=True,activation='relu',padding='same',
                       kernel_initializer='he_normal')(layer_6)
        layer_7=Dropout(0.15)(layer_7)
        layer_8=Conv2D(32,(3,3),use_bias=True,activation='relu',padding='same',
        ...
        layer_10=Conv2D(64,(3,3),use_bias=True,activation='relu',padding='same',
                       kernel_initializer='he_normal')(layer_9)
        layer_10=Dropout(0.2)(layer_10)
        layer_11=Conv2D(64,(3,3),use_bias=True,activation='relu',padding='same',
        ...
        layer_19=Dense(self.OUTPUT_SIZE,use_bias=True,kernel_initializer='he_normal')(layer_18)
        y_pred=Activation('softmax',name='softmax')(layer_19)
...
if(__name__ == '__main__'):
    ...
    S_M.LoadModel('lz_test1')
    S_M.TrainModel('lz_test1',epochs=200)
