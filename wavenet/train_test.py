...
if __name__ == "__main__":    
    ...
    checkpoint_dir = 'egs\\biaobei\\exp\\biaobei_train_no_dev_biaobei'
    checkpoint_path = args["--checkpoint"]
    checkpoint_restore_parts = args["--restore-parts"]
    speaker_id = args["--speaker-id"]
    speaker_id = int(speaker_id) if speaker_id is not None else None
    preset = 'egs\\biaobei\\conf\\biaobei.json'
    
    dump_root = 'egs\\biaobei\\dump\\biaobei\\logmelspectrogram\\norm'
    if dump_root is None:
        dump_root = join(dirname(__file__), "data", "ljspeech")

    log_event_path = 'egs\\biaobei\\tensorboard\\biaobei_train_no_dev_biaobei'
